    ...
    <div class="position-relative">
      <section class="section section-lg pt-0 pb-0">
        <div
          ...
          style="background-image: linear-gradient(to right top, #e1cda3, #e3ceac, #e3cfb5, #e2d1be, #e0d3c7);"
        >
...
export default {
 data() {
  ...
  mounted() {
    ...
    this.$store.dispatch("getImagesAll");
  ...
  methods:{
    ...
    onPreviouse() {
        ...
        axios.get("https://capstoneprojectapi20210418160622.azurewebsites.net/api/v1/Photo/SearchPhoto/" + searchValue + "?PageSize=21&CurrentPage=" + currentPage)
            .then((response) => {
                this.imagesearch = response.data;
                this.xpagination = response.headers["x-pagination"];
                this.xpagination = this.xpagination.replaceAll('"', "");
